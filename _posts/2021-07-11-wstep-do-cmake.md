...
`cmake --build .` jest uniwersalne, ale można użyć `make` (lub `make -j`) jeśli wiemy, że generujemy pliki `Makefile`.
...
- [Kuba Sejdak - 19 reasons why CMake is actually awesome](https://kubasejdak.com/19-reasons-why-cmake-is-actually-awesome)
- [Kuba Sejdak - Modern CMake is like inheritance](https://kubasejdak.com/modern-cmake-is-like-inheritance)