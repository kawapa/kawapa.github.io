...
* **Sytuacja w której przerywasz wykonywanie jedno zadania na pewnym nie do końca określonym etapie i zaczynasz pracować nad czymś innym (rozgrzebujesz zadania)**
...
W sytuacji gdy masz mnóstwo zadań na głowie, a otrzymujesz do zrobienia kolejne, dostajesz tak na prawdę w pakiecie dwie rzeczy:
* Nowy task do wykonania oraz
...
* Wszystkie tematy które do Ciebie trafiają wpisujesz do tak zwanego **rejestru**
    ...
    * Wykonujesz daną czynność od razu jeśli jej pracochłonność oceniasz na mniej niż 5 minut
* Okresowo przeglądasz zawartość rejestru i zamieniasz te bliżej nieskonkretyzowane tematy którymi masz się zająć w jasno zdefiniowane zadania
    * **Konkretyzując zadania sprawiasz, że późniejsza praca nad nimi będzie przyjemniejsza i bardziej płynna**
...
### Cechy dobrego rejestru
{: .no_toc }

* Rejestr jest tylko jeden
* Rejestr jest zawsze widoczny/otwarty
* Rejestr powinien umożliwiać sortowanie zadań (wizualna kolejność zadań dobrze odzwierciedla priorytet)
* Rejestr powinien umożliwiać grupowanie zadań (utrzymanie porządku)
...
* Potencjalnie zajmie mniej niż 4 h (w zasadzie im są krótsze, tym lepiej)
    ...
    * Łatwiej monitorować postępy w pracy jeśli wiesz, że zrobiłeś na przykład 17 z 25 zadań w ramach jakiegoś projektu

Przechowywanie tak zdefiniowanych zadań ma jeszcze jedną olbrzymią zaletę:
* Typowy dzień pracy programisty składa się z kilku/kilkunastu "sesji programowania" przeplatanych przeróżnymi przerywnikami (rozmowy ze współpracownikami, spotkania, telefony itp.)
* Po każdym takim przerywniku, kiedy chcesz wrócić do programowania musisz przypomnieć sobie o co chodzi w tym zadaniu (przypomnieć sobie jego kontekst).
...
1. Na górze kartki zapisz, w postaci jednego pytania, problem który starasz się rozwiązać
2. Pod pytaniem zacznij wypisywać wszystkie odpowiedzi jakie przychodzą Ci do głowy
    * Na tym etapie nie oceniaj pomysłów
...
### Jak zapoznawać się z książką? - Metoda Balcerowicza
{: .no_toc }
...
* Programując w skupieniu, znajdujesz się w określonym stanie psychicznym który często jest wywoływany lub wzmacniany przez jakiś bodziec.
    * Najczęściej jest to określona rutyna poprzedzająca daną czynność lub środowisko w którym ją wykonujesz
